...
class GetSunsetPhotosUpdatedUseCaseTest {
    private lateinit var usecase: GetSunsetPhotosUpdatedUseCase
    ...
    @Before
    fun setUp() {
        usecase = GetSunsetPhotosUpdatedUseCase(photoRepository)
    }
